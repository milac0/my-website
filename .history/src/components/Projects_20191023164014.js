...
const Projects = () => {
    return (
        ...
        <article>
            ...
            <a href="https://quotemachine-milac.netlify.com/" target="_blank" rel="noopener noreferrer">
        ...
        <article>
            ...
            <a href="https://markdown-milac.netlify.com/" target="_blank" rel="noopener noreferrer">
                <img className="project-image" src={markdownImg} alt="markdown-previewer" />
            </a>
            <p>nothing</p>
        </article>
        <article>
            <h2>Drum Machine</h2>
            <a href="https://drummachine-milac.netlify.com/" target="_blank" rel="noopener noreferrer">
        ...
        <article>
            ...
            <a href="https://pomodoro-clo.netlify.com/" target="_blank" rel="noopener noreferrer">
                <img className="project-image" src={pomodoroImg} alt="pomodoro clock" />
            </a>
            <p>hooks, axios, material-ui</p>
        </article>
        </section>
