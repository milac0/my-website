        ...
        <Formik
                ...
                render={({ errors, status, touched }) => (
                    <Fragment>
                        ...
                        <div className="form-group">
                            <button type="submit" className={styles.buttonSubmit}>{loading ? <CircularProgress className={styles.progress} color="primary" size="1rem"/> : 'Submit'}</button>
                        </div>
                    </Form>
...
export default withStyles(theme)(FormContact);