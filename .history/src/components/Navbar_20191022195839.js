        ...
        <div class="container">
            <nav>
                <li>
                    ...
                    {/* <ul><img  class="nav-item" src="images/resume.png" alt="resume" /></ul>
                    <ul><img  class="nav-item" src="images/linkedin.png" alt="linkedin" /></ul>
                    <ul><img  class="nav-item" src="images/github.png" alt="github" /></ul> */}
                </li>
            </nav>
        </div>
    </header>
