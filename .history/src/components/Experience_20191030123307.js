    ...
    <section>
      ...
      <div className="section-skills">
        <div className="section-skill">
          ...
          <p>
            There is not a lot difference between finding out where the error
            happened and narrowing down opponents card range.
          </p>
        </div>
        <Skill title="Analytical and Systematic Approach" body="There is not a lot difference between finding out where the error
            happened and narrowing down opponents card range." imageSrc={analyticalImg} />
        <div className="section-skill">
          <div className="responsive-container">
            <LazyLoad>
              <img
