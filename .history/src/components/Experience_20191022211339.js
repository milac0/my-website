...
const Experience = () => {
    return (
        <section>
                ...
                <p className="section-body">I have a work experience of a self-employed online poker player. 
                  ...
                  skills that are translatable into programming:</p>
                    <div className="section-skill">
                        <img className="section-skill-image" src={analyticalImg} alt="analytical" />
