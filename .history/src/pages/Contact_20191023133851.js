        ...
        <div className={styles.container}>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li><img className="nav-item" src={phoneIcon} alt="phone" /><span>+385 91 918-2865</span></li>
                    <li><img className="nav-item" src={linkedinIcon} alt="linkedin" /><span>Mile Balenović</span></li>
                    <li><img className="nav-item" src={skypeIcon} alt="skype" /><span>mbalenovic</span></li>
                </ul>
            </section>
        </div>
    </main>
