        ...
        <div className={styles.container}>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li><img className="nav-item" src={githubIcon} alt="github" />phone</li>
                    <li><img className="nav-item" src={githubIcon} alt="github" />linkedin</li>
                    <li><img className="nav-item" src={githubIcon} alt="github" />skype</li>
                </ul>
            </section>
        </div>
    </main>
